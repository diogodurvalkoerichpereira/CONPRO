...
if($linhas > 0){
	...
	if($_SESSION['nivel_usuario'] == 'Estudante'){
		echo "<script language='javascript'>window.location='painel-estudante/index.php'; </script>";
		exit();
	}
	if($_SESSION['nivel_usuario'] == 'Profissional'){
		echo "<script language='javascript'>window.location='painel-profissional/index.php'; </script>";
		exit();
	}
