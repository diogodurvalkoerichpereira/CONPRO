...
<head>
    ...
    <meta name="description" content="Sitemas para estudantes e profissionais ca contabilidade ">
    <meta name="author" content="Diogo Durval">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 login-sec">
                    <h5 class="text-center mb-4" align="center" >Faça seu Login</h5>
                    ...
                    <div id="demo" class="carousel slide carousel-fade" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="IMG/Con Proo.PNG" height="100%" width="100%">
...
<div class="modal-footer">
   <button type="button" id="btn-fechar" class="btn btn-warning" data-dismiss="modal">Fechar</button>
   <button name="btn-cadastro" id="btn-cadastro" class="btn btn-success">Cadastrar</button>
