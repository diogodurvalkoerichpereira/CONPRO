...
<div class="container ml-2 mr-2">
	<nav class="navbar navbar-expand navbar-white navbar-light">
		...
		<a id="btn-novo" type="button" class="btn btn-primary" href="index.php?acao=<?php echo $pagina ?>&funcao=novo">Novo Cliente</a>
			...
			<div class="modal-body">
				...
				<form id="<?php echo $form ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="id" placeholder="Insira o id " name="id" value="<?php echo @$id ?>" required>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="email" placeholder="Insira o Email " name="email" value="<?php echo @$email ?>" required>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="estado" placeholder="Insira a Estado " name="estado" value="<?php echo @$estado ?>" >
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="cidade" placeholder="Insira a Cidade " name="cidade" value="<?php echo @$cidade ?>" >
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="bairro" placeholder="Insira o Bairro " name="contas" value="<?php echo @$bairro ?>" >
					</div>
					<div class="form-group">


						<label for="exampleFormControlInput1">rua</label>
						<input type="text" class="form-control" id="rua" placeholder="Insira a Rua " name="rua" value="<?php echo @$rua ?>" >
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="numero" placeholder="Insira o numero " name="numero" value="<?php echo @$numero ?>" >
					</div>
					<div class="form-group">


						<label for="exampleFormControlInput1">cep</label>
						<input type="text" class="form-control" id="cep" placeholder="Insira o cep " name="cep" value="<?php echo @$cep ?>" >
					</div>
